...
public class SocketServer implements Runnable {
    ...
    public SocketServer(ServerFrame frame){
        ...
        ////////////************
        File historyFile = new File("src/com/socket/History.xml");
        
        if(historyFile != null){
            filePathHis = historyFile.getAbsolutePath();
            
                filePathHis =  filePathHis.replace("\\", "/");
             filePathHis =  filePathHis.replace("/dist/", "/");
            
          
        }
        hist = new History(filePathHis);
        //////////////****************
